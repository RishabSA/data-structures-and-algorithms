...
class AVLTree:
    ...
    def NodeHeight(self, currentNode):
        if currentNode == None:
            return 0
    ...
    def LeftRotation(self, currentNode):
        if currentNode.right != None:
            ...
            currentNode.height = 1 + max(
                self.NodeHeight(currentNode.left), self.NodeHeight(currentNode.right)
            )
            rightNode.height = 1 + max(
                self.NodeHeight(rightNode.left), self.NodeHeight(rightNode.right)
            )
    ...
    def RightRotation(self, currentNode):
        if currentNode.left != None:
            ...
            leftNode.height = 1 + max(
                self.NodeHeight(leftNode.left), self.NodeHeight(leftNode.right)
            )

    def CheckBalance(self, currentNode):
        ...
        if self.NodeHeight(currentNode.left) - self.NodeHeight(currentNode.right) > 1:
            if (
                self.NodeHeight(currentNode.left.left)
                - self.NodeHeight(currentNode.left.right)
                > 0
            ):
            ...
            self.NodeHeight(currentNode.left) - self.NodeHeight(currentNode.right) < -1
        ):
            if (
                self.NodeHeight(currentNode.right.left)
                - self.NodeHeight(currentNode.right.right)
                < 0
            ):
                self.LeftRotation(currentNode)
            else:
